public class InfiniteArray {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("infinteArray: " + infinteArray(sortedNums, 10));
        System.out.println("infinteArray: " + infinteArray(sortedNums, 14));



    }

    private static int infinteArray(int[] sortedNums, int target) {
